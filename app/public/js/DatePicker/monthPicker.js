	...
	*/
	...
	hdlPeriod : function(evt){
		...
		if( monthPicker.Params.current ==  monthPicker.Constant.START_MONTH){
			...
			//这里做下比较，然后确定大小关系。
			if( monthPicker.Params.start_year*1 >  monthPicker.Params.end_year*1 || ( monthPicker.Params.start_year*1 <=  monthPicker.Params.end_year*1 &&  monthPicker.Params.start_month*1 > monthPicker.Params.end_month*1) ){
				var tmp = start;
				start = end;
				end= tmp;
			}
